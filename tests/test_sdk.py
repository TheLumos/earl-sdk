...
Usage:
    # Option 1: Pass credentials via CLI args:
    python test_sdk.py --client-id "your-id" --client-secret "your-secret" --test all
    
    # Option 2: Set credentials in CREDENTIALS section below
    ...
    # Or run integration tests with external doctor:
    python3 test_sdk.py --client-id "your-id" --client-secret "your-secret" \
        --env test --test external \
...
def get_credentials(
    ...
    cli_organization: Optional[str] = None,
) -> tuple[str, str, str]:
    """Get credentials from CLI args, CREDENTIALS dict, or environment variables."""
    # Priority: CLI args > CREDENTIALS dict > environment variables
    ...
    if missing:
        ...
        print("\nOption 1: Use CLI args: --client-id <id> --client-secret <secret>")
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Auth0 M2M client ID (or set EARL_CLIENT_ID env var)",
    )
    parser.add_argument(
        "--client-secret",
        type=str,
        default=None,
        help="Auth0 M2M client secret (or set EARL_CLIENT_SECRET env var)",
    )
    parser.add_argument(
        "--organization",
        type=str,
        default=None,
        help="Auth0 organization ID (optional)",
    )
    parser.add_argument(
        "--test",
        choices=[
    ...
    # Get credentials (CLI args take priority)
